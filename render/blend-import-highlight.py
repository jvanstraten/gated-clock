...
bpy.ops.wm.obj_import(
    filepath='../output/mainboard.Highlight.obj',
...
for obj in bpy.data.objects:
    ...
    for slot in obj.material_slots:
        if slot.material.name_full.startswith('substrate'):
            slot.material = bpy.data.materials.get('Highlight')
        else:
            print(slot.material.name_full)
            assert False

bpy.data.collections['Collection'].name = 'Highlight'

bpy.ops.wm.save_as_mainfile(filepath='../output/mainboard.Highlight.blend')
